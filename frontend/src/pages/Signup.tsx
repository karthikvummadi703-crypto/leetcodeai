...
const HexLogo = ({ size = 48 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="signupHexGrad" x1="0" y1="0" x2="64" y2="64">
        <stop offset="0%" stopColor="#4D82FF"/>
        <stop offset="100%" stopColor="#9EBCFF"/>
      </linearGradient>
    </defs>
    <path d="M32 2 L58 17 L58 47 L32 62 L6 47 L6 17 Z" fill="url(#signupHexGrad)" stroke="rgba(255,255,255,0.15)" strokeWidth="1"/>
...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-[#05070D] flex items-center justify-center p-6 relative overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-[120px] -ml-64 -mt-64" />
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-blue-600/5 rounded-full blur-[120px] -mr-64 -mb-64" />
          ...
          <CardHeader className="space-y-4 text-center pt-12 pb-6">
            ...
            <div className="space-y-1">
              ...
              <CardDescription className="text-blue-400/60 font-medium">
                Your journey to elite status begins here
              </CardDescription>
            </div>
          </CardHeader>
          ...
          <CardContent className="px-10 pb-8">
            <form onSubmit={handleSignup} className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="relative group">
                  ...
                  <Input 
                    ...
                    required 
                    className="pl-12 h-12 glass-input rounded-2xl bg-white/[0.02] text-white border-white/5 placeholder:text-white/20"
                  />
                </div>

                {/* Email */}
                <div className="relative group">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-white/30 group-focus-within:text-blue-400 transition-colors" />
                  <Input 
                    type="email" 
                ...
                <div className="relative group">
                  ...
                  <Input 
                    ...
                    required 
                    className="pl-12 pr-12 h-12 glass-input rounded-2xl bg-white/[0.02] text-white border-white/5 placeholder:text-white/20"
                  />
                  <button
                    type="button"
              ...
              <Button 
                type="submit" 
                disabled={isLoading}
                className="w-full h-12 btn-gradient rounded-2xl text-base font-bold mt-2"
              >
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-[0.2em] font-bold text-white/20">
                <span className="bg-[#0D121E] px-4">Social Sign Up</span>
              </div>
            </div>
            ...
            <Button 
              ...
              disabled={isLoading}
              className="w-full h-12 rounded-2xl border-white/5 bg-white/[0.02] hover:bg-white/[0.05] text-white font-bold transition-all"
            >
